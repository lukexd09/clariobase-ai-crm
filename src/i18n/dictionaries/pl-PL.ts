...
export const plPL = {
  ...
  ,"dashboard.duplicates": "Potencjalne duplikaty wymagające weryfikacji: {count}"
  ,"dashboard.review": "Sprawdź"
  ,"dashboard.noDeadline": "Brak terminu"
  ,"dashboard.prioritiesEmpty": "Brak priorytetów wymagających działania."
  ,"dashboard.pipeline.intake": "Przyjęcie"
  ,"dashboard.pipeline.audit": "Audyt"
  ,"dashboard.pipeline.conversation": "Kontakt i rozmowa"
