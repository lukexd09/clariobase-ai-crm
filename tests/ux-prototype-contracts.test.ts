...
test("ux prototype routes stay isolated from Prisma and production mutations", () => {
  ...
  assert.match(read("src/components/ux-prototype-shell.tsx"), /Menu ·/);
  assert.match(read("src/components/ux-prototype-shell.tsx"), /Data quality/);
  assert.match(read("src/components/ux-prototype-shell.tsx"), /min-\[1100px\]:grid-cols/);
  assert.match(read("src/components/ux-prototype-shell.tsx"), /<details className="rounded-2xl border border-slate-200 bg-white p-3"/);
  ...
  assert.match(read("src/components/ux-prototype-shell.tsx"), /Hub/);
  assert.doesNotMatch(read("src/components/ux-prototype-shell.tsx"), /description: "Review completed import batches\."/);
  assert.doesNotMatch(read("src/components/ux-prototype-shell.tsx"), /description: "Review likely duplicate candidates\."/);
  assert.match(read("src/app/ux-prototype/leads/[id]/page.tsx"), /Leads/);
  assert.match(read("src/app/ux-prototype/leads/[id]/page.tsx"), /Aurora Bikes Studio/);
  assert.match(read("src/app/ux-prototype/import-batches/[id]/page.tsx"), /Imports/);
  assert.match(read("src/app/ux-prototype/import-batches/[id]/page.tsx"), /Batch details/);
  assert.match(read("src/app/ux-prototype/duplicate-candidates/[id]/page.tsx"), /Possible duplicates/);
  assert.match(read("src/app/ux-prototype/duplicate-candidates/[id]/page.tsx"), /Compare records/);
